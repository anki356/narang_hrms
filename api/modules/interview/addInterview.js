...
const addInterview= (req, res, next) => {
    ...
    database.query("Select * from roles where id=" + role_id, (err, result) => {
        ...
        if (allowed_roles.includes(result[0].role_name)) {
            database.query("Insert into interview (name,interviewer_employee_id,expected_salary,fathers_name,qualification,date_time,remarks,designation_id,experience,reference_id) values( "+req.body.name+","+req.body.interviewer_employee_id+","+req.body.expected_salary+","+req.body.fathers_name+","+req.body.qualification+","+ req.body.date_time+","+req.body.remarks+","+req.body.designation_id+","+req.body.experience+","+req.body.reference_id+")",async(err, interviewResult, fields) => {
                console.log(err)
