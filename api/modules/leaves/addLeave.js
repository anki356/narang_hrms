...
const addLeave = (req, res, next) => {
    ...
    database.query("Select * from roles where id=" + role_id, (err, result) => {
        ...
        if (allowed_roles.includes(result[0].role_name)) {
            ...
            database.query("Insert into attendance (employee_id,status,approval_document_id) values("+req.body.employee_id+",'On leave',"+fileResult.insertId+")" , (err, attendanceData, fields) => {
